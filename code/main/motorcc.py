...
class Car :
    global EN_M0,EN_M1,Motor0_A,Motor0_B,Motor1_A,Motor1_B
    global setup,forward,backward,pins,ctrl,stop,setSpeed,motor0,motor1,turn
    Motor0_A = 11
    Motor0_B = 12
    Motor1_A = 13
    Motor1_B = 15
...
# ===========================================================================
    def setSpeed(self):
        ...
        pwm.write(EN_M0, 0, self.speed)
        pwm.write(EN_M1, 0, self.speed)
